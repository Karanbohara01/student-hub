...
var createComment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var note, comment, createdComment, _t;
...
// @access  Public
var getCommentsByNoteId = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          return Comment.find({
            note: req.params.noteId
          }).populate('user', 'name profilePicture').sort({
            createdAt: 'asc'
          });
        case 1:
          comments = _context2.v;
  ...
  return function getCommentsByNoteId(_x3, _x4) {
